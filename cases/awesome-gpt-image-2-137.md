...
inputs:
  reference_images: 1
preview: "https://raw.githubusercontent.com/freestylefly/awesome-gpt-image-2/main/data/images/case137.jpg"
---

```prompt
{
  "type": "e-commerce landing page hero section mockup",
  "aesthetic": "clean, bright, airy, feminine, floral accents with purple flowers, soft pink and white color palette, soft lighting",
  "header": {
    "logo": "LUMEA BEAUTY",
    "navigation_links": {
      "count": 5,
  ...
  "hero_section": {
    ...
    "center_subject": {
      "model": "young East Asian woman smiling, touching her cheek",
      "action": "holding a dropper bottle of serum"
    },
    "right_column": {
      "product_display": {
        "count": 2,
        "items": ["moisturizing boost serum dropper bottle", "packaging box"]
      },
      "stat_cards": {
        "count": 3,
