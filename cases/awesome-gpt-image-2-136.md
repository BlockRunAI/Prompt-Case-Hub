...
inputs:
  reference_images: 1
preview: "https://raw.githubusercontent.com/freestylefly/awesome-gpt-image-2/main/data/images/case136.jpg"
---
...
```prompt
{
  ...
  "color_palette": ["white", "teal", "light blue"],
  "layout": {
    "header": {
      "logo": "CLEAR RESET",
    ...
    "visuals": {
      "model": "young Asian woman with clear radiant skin, hair tied up, smiling softly",
      "products": {
        "count": 2,
        "description": "acne care gel tube and lotion bottle",
        "placement": "center"
      },
