---
id: awesome-gpt-image-2-51
title: "例 51：信息图可视化设计"
modality: video
tags: ["headshot", "ui-system", "lookbook", "ad-series", "card-deck", "infographic"]
source:
...
inputs:
  reference_images: 0
preview: "https://raw.githubusercontent.com/freestylefly/awesome-gpt-image-2/main/data/images/case51.jpg"
---
...
```prompt
{
  ...
  "header": {
    ...
    "slogan_en": "ELEGANCE HAS NO LIMIT, BE CONFIDENT EVERY DAY"
  },
  "subject": "young elegant Asian woman",
  "layout": {
    "columns": 7,
    "column_elements": [
      "day_header",
  ...
  "footer": {
    "tips": "Tips: 根据天气与场合灵活调整，配饰是提升整体造型的关键；保持自信与舒适，才是穿搭的最终目的。",
    "legend": [
      "春: 春季适用",
      "夏: 夏季适用",
      "秋: 秋季适用",
