...
inputs:
  reference_images: 1
preview: "https://raw.githubusercontent.com/freestylefly/awesome-gpt-image-2/main/data/images/case123.jpg"
---
...
```prompt
{
  ...
  "character": {
    "name": "真田大助",
    "appearance": "young warrior with long brown hair, wearing samurai-inspired armor, red chest plate and guards, navy blue pleated hakama, white short cape"
  },
  "layout": {
    "header": {
      "title": "真田大助",
      "subtitle": "戦国時代を舞台にした物語の主人公。日英クォーターの若き武将。",
      "badge": "設定資料"
    },
    "right_side": {
